...
class TestReservas(unittest.TestCase):
    ...
    @patch("builtins.open", new_callable=mock_open, read_data='[{"asientos": ["B1", "B2"]}]')
    ...
    def test_ejecutar_reserva(self, mock_wrapper, mock_guardar, mock_ocupados, mock_funciones):
    ...
    @patch("reservas.guardar_reserva")
    def test_ejecutar_reserva_sin_asientos(self, mock_guardar, mock_wrapper, mock_funciones):
